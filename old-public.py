...
"""
    ...
    CRED_DIR = os.path.join(DIRECTORY, "dependencies", "credentials")
    gc = gspread.oauth(
        credentials_filename=os.path.join(CRED_DIR, 'credentials.json'),
        authorized_user_filename=os.path.join(CRED_DIR, 'authorized_user.json')
    )

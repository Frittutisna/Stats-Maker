...
"""
    ...
    DEP_DIR = os.path.join(DIRECTORY, "dependencies")
    gc = gspread.oauth(
        credentials_filename=os.path.join(DEP_DIR, "credentials", "credentials.json"),
        authorized_user_filename=os.path.join(DEP_DIR, "credentials", "authorized_user.json")
    )
